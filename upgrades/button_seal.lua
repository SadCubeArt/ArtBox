    ...
    if context.cardarea == G.play and context.main_scoring then
      ...
      if G.hand and G.hand.cards and #G.hand.cards > 0 then
        for _, v in ipairs(G.hand.cards) do
          if v.base.suit ~= card.base.suit and not v['artb_button_queued_'..card.base.suit] then
        ...
        if next(valid_targets) then
          ...
          _card['artb_button_queued_'..card.base.suit] = true
          G.E_MANAGER:add_event(Event({
            ...
            func = function()
              ...
              _card['artb_button_queued_'..card.base.suit] = nil
              return true
            end
          }))
        end
