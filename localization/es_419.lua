return {
    misc = {
        dictionary = {
            ...
            artb_empty= "Vacío",
            artb_bug= "¡Bug!",
            k_collectable = "Coleccionable",
            b_collectable_cards = "Coleccionables",
            k_art = "Carta de Arte",
            b_art_cards = "Cartas de Arte",
        },
        labels = {
    ...
    descriptions = {
        Joker = {
            ...
            j_artb_bug = {
                name = 'Miren, un bicho',
                text = {{
                    "{C:attention}???{} cuando la mano anotada",
                    "contiene {C:attention}???{}",
                }}
            },
            j_artb_recursion = {
                name = 'Recursión',
                text = {{
                    "Crea una {C:attention}Etiqueta Recursiva{}",
                    "cuando al derrotar una {C:attention}Ciega Jefe{}"
                }}
            },
            j_artb_claymation = {
                name = 'Claymation',
                text = {{
                    "Saca una {C:attention}Carta de Arcilla{}",
                    "de tu {C:attention}baraja{}",
                    "al inicio de la ronda"
                }}
            },
            j_artb_stained_joker = {
                name = 'Comodín Manchado',
                text = {{
                    "Si el {C:attention}primer descarte{} de la",
                    "ronda tiene solo {C:attention}1{} carta,",
                    "se convierte en una {C:attention}Carta Manchada{}"
                }}
            },
            j_artb_scalper = {
                name = 'Revendedor',
                text = {{
                    ...
                    "deja tu dinero en {C:money}$0{} y crea",
                    "un {C:attention}Comodín Coleccionable{}",
                    "por cada {C:money}$#1#{} perdido"
                }}
            },
        },
        collectable = {
        ...
        Tag = {
            ...
            tag_artb_recursive = {
                name = "Etiqueta Recursiva",
                text = {
                    "Otorga #1# {C:attention}Etiqueta(s){}",
                    "al azar por cada",
                    "{C:attention}Etiqueta Recursiva{} obtenida",
                }
            }
        },
        art = {
        ...
        Other = {
            undiscovered_collectable = {
                name = 'Coleccionable Desconocido',
                text = { 'Encuentra esta carta en una', 'partida sin códigos para descubrirla' }
            },
            undiscovered_art = {
                name = 'Carta de Arte Desconocida',
                text = { 'Encuentra esta carta en una', 'partida sin códigos para descubrirla' }
            },
            artb_Uroboros_seal = {
                ...
                text = {
                    ...
                    'una copia exacta a tu {C:attention}baraja{}'
                }
            },
            artb_brick_seal = {
                name = 'Sello de Lego',
